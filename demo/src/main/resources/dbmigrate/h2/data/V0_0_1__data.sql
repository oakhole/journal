...
insert into user (id,username, name,email, password, salt,status) values(3,'guest','来宾用户','cc@cc.com','7308c9fc069595af791e55bbc29db809cb627f79','fcfc26e15a99d7ad','enabled');
