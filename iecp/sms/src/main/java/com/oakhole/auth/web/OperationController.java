...
public class OperationController {
    ...
    private OperationService operationService;
     ...
     @RequestMapping(value = {"", "list"})
        public String list(@RequestParam(value = "pageNumber", defaultValue = "0") int pageNumber,
            ...
            Page<Operation> operations = this.operationService.findAll(searchParams, pageNumber, pageSize,sortDirection,sortBy);
    ...
    public String create(@Valid Operation operation, RedirectAttributes redirectAttributes) {
