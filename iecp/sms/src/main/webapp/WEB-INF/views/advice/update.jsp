	...
	<div class="content-box role">
		<div class="content-box-header">
			<h3 style="cursor: s-resize;">
				更新公告&nbsp;&nbsp;[<a href="advice-manage!findAllAdvice">公告管理</a>]
			</h3>
			<div class="clear"></div>
		</div>
						...
						<tbody>
							<tr class="alt-row">
								...
								<td height="25" width="*" align="left"><input class=""
									...
									type="text" value="${advice.title}"><font color="red">*</font>
								</td>
							</tr>
							<tr class="alt-row">
								...
								<td height="25" width="*" align="left"><textarea
										...
										style="width:600px;height:200px;margin-top:3px;">${advice.content}</textarea><font
									color="red">*</font></td>
							</tr>
