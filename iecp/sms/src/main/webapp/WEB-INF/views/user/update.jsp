...
<div class="main wd">
    ...
    <div class="right-info left">
        ...
        <form class="form-horizontal" method="post" action="${ctx}/user/update">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="name" class="form-control input-sm required" value="${user.name}"
                        readonly/>
                    </div>
                </div>
                <div class="form-group">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input id="plainPassword" type="password" name="plainPassword" class="form-control input-sm"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label"><span class="text-danger">*</span> 确认密码</label>
                    <div class="col-sm-5">
                        <input type="password" name="confirmPassword" class="form-control input-sm" equalTo="#plainPassword"/>
                    </div>
                </div>
                <div class="form-group">
