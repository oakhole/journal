...
public class SmsController {
    ...
    public String show(@PathVariable Long id, @Valid @ModelAttribute("sms") Sms sms, Model model) {
    ...
    public String update(@PathVariable Long id, @Valid @ModelAttribute(value = "sms") Sms sms, Model model) {
        model.addAttribute("sms", sms);
        return "sms/update";
    }
    ...
    public String delete(@PathVariable Long id, @Valid @ModelAttribute(value = "sms") Sms sms, RedirectAttributes redirectAttributes) {
        this.smsService.remove(sms);
